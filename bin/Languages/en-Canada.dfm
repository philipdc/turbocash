object TTranslationSaveObject
  aTranslationCollection = <
    ...
    item
      IndexID = 711
      Text = 
        'Run Setup -> Journal types and select contra account for this jo' +
        'urnal!'
    end
    item
      IndexID = 712
    ...
    item
      IndexID = 3076
      Text = 
        'Theres still inventory items using this group! Please remove the' +
        'm first!'
    end
    item
      IndexID = 3077
    ...
    item
      IndexID = 1000000
      Text = 'United States of America (English)'
    end
    item
      IndexID = 1000001
    ...
    item
      IndexID = 906066
      Text = 'Selected vendors delivery label'
    end
    item
      IndexID = 906067
      Text = 'Payments'
    ...
    item
      IndexID = 3302
      Text = 'Limit inventory purchase only for default suppier or non'
    end
    item
      IndexID = 3303
      Text = 'Welcome'
    ...
    item
      IndexID = 906167
      Text = 'Graph - Vendor per week'
    end
    item
      IndexID = 906168
      Text = 'Graph - Customer per week'
    end
    item
      IndexID = 906169
    ...
    item
      IndexID = 906314
      Text = 'Vendor returns per period - Cost'
    end
    item
      IndexID = 906315
    ...
    item
      IndexID = 906316
      Text = 'Estimate per period - Turnover'
    end
    item
      IndexID = 906317
    ...
    item
      IndexID = 906322
      Text = 'Graph - Vendor returns per week - Cost'
    end
    item
      IndexID = 906323
    ...
    item
      IndexID = 906324
      Text = 'Graph - Estimate per week - Turnover'
    end
    item
      IndexID = 906325
