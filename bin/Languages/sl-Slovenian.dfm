object TTranslationSaveObject
  aTranslationCollection = <
    ...
    item
      IndexID = 17
      Text = '&Pripravi knjige'
    end
    item
      IndexID = 18
      Text = '&Izbri'#353'i knjige'
    end
    item
      IndexID = 20
      Text = '&Zamenjaj jezik'
    ...
    item
      IndexID = 25
      Text = '&Ponavljajoci vnosi'
    end
    item
      IndexID = 26
      Text = 'Ponavljajoci &racuni'
    end
    item
      IndexID = 27
      Text = '&Skladi'#353'ce'
    ...
    item
      IndexID = 39
      Text = 'Izbri'#353'i racune'
    end
    item
      IndexID = 40
      Text = 'Izbri'#353'i nabavo'
    end
    item
      IndexID = 41
      Text = 'Izbri'#353'i vracilo izdelka'
    end
    item
      IndexID = 42
      Text = '&Prilagodi zalogo'
    end
    item
      IndexID = 43
      Text = '&Ulaz skupine'
    ...
    item
      IndexID = 44
      Text = '&Bancna poravnava'
    end
    item
      IndexID = 45
      Text = '&Pregled dokumentov'
    end
    item
      IndexID = 46
      Text = 'Vpi'#353'i v knjigo'
    end
    item
      IndexID = 47
      Text = '&Dobropis'
    ...
    item
      IndexID = 53
      Text = '&Osve'#382'i glavno knjigo'
    end
    item
      IndexID = 54
      Text = 'Izpis& Dobavnice'
    end
    item
      IndexID = 55
      Text = '&Vrsta skupine'
    ...
    item
      IndexID = 84
      Text = '&Seznam izdelkov'
    end
    item
      IndexID = 85
      Text = 'Analiza prodaje'
    end
    item
      IndexID = 86
      Text = '&Podrobnosti racuna'
    end
    item
      IndexID = 87
      Text = '&Skupaj racuni'
    ...
    item
      IndexID = 88
      Text = '&Primljeno /Detalji placanja'
    end
    item
      IndexID = 89
      Text = 'Primljeno / &Ukupno placanje'
    end
    item
      IndexID = 90
      Text = '&Kontrola dostopa'
    end
    item
      IndexID = 91
      Text = 'Backup & Path'
    ...
    item
      IndexID = 103
      Text = 'Informacije o skladi'#353'cu'
    end
    item
      IndexID = 104
      Text = '&Arhiviranje / Obnova knjig'
    end
    item
      IndexID = 105
      Text = '&Kalkulator'
    ...
    item
      IndexID = 106
      Text = '&Preverjanje integritete podatkov'
    end
    item
      IndexID = 107
      Text = '&Izvoz'
    ...
    item
      IndexID = 114
      Text = '&Ci'#353'cenje / Resetiranje'
    end
    item
      IndexID = 115
      Text = '&Naredi zakljucek leta'
    end
    item
      IndexID = 116
      Text = '&Poravnava'
    ...
    item
      IndexID = 175
      Text = 'Ime nove skupine knjig'
    end
    item
      IndexID = 176
      Text = #352'tevilka konta'
    end
    item
      IndexID = 177
      Text = 'Pod-konto'
    ...
    item
      IndexID = 179
      Text = 'Porocilo skupine 1'
    end
    item
      IndexID = 180
      Text = 'Porocilo skupine 2'
    end
    item
      IndexID = 181
      Text = 'Placila'
    ...
    item
      IndexID = 201
      Text = 'Racun onemogocen'
    end
    item
      IndexID = 202
      Text = 'Davcna '#353'tevilka'
    end
    item
      IndexID = 203
      Text = 'Popust kupca'
    ...
    item
      IndexID = 215
      Text = 'Zadnja nabavna cena'
    end
    item
      IndexID = 216
      Text = 'Prodajna cena 1'
    end
    item
      IndexID = 217
      Text = 'Prodajna cena 2'
    end
    item
      IndexID = 218
      Text = 'Prodajna cena 3'
    end
    item
      IndexID = 219
      Text = 'Vstopni davek'
    ...
    item
      IndexID = 221
      Text = 'Nivo ponovnog narucivanja'
    end
    item
      IndexID = 222
    ...
    item
      IndexID = 224
      Text = 'Stro'#353'ki prodaje'
    end
    item
      IndexID = 225
      Text = 'Kontrola zaloge'
    end
    item
      IndexID = 226
      Text = 'Povprecni stro'#353'ek'
    end
    item
      IndexID = 227
      Text = 'Kolicina na zalogi'
    end
    item
      IndexID = 228
      Text = 'Celotni stro'#353'ki'
    end
    item
      IndexID = 229
      Text = 'Zadnji racun'
    ...
    item
      IndexID = 243
      Text = 'Od datuma porocanja'
    end
    item
      IndexID = 244
      Text = 'Vsako obdobje posebej'
    end
    item
      IndexID = 245
      Text = 'Poka'#382'i zacetna stanja'
    end
    item
      IndexID = 246
      Text = 'Od konta'
    ...
    item
      IndexID = 248
      Text = 'Vkljuci nicne bilance'
    end
    item
      IndexID = 249
      Text = 'Mo'#382'nosti porocil za transakcije dobaviteljev'
    end
    item
      IndexID = 250
      Text = 'Bancni racun'
    ...
    item
      IndexID = 253
      Text = 'Konto Glavne knjige salda konta'
    end
    item
      IndexID = 254
      Text = 'Davcni konto'
    ...
    item
      IndexID = 263
      Text = 'Vremenska analiza placanja du'#382'nika'
    end
    item
      IndexID = 264
      Text = 'Minimalni znesek'
    end
    item
      IndexID = 265
      Text = 'Uporabi odprto postavko'
    end
    item
      IndexID = 266
      Text = 'Zanemari niclo bilanco'
    end
    item
      IndexID = 267
      Text = 'Prika'#382'i podrobnosti konta'
    end
    item
      IndexID = 268
      Text = 'Razvrsti po imenu'
    end
    item
      IndexID = 269
      Text = 'Prika'#382'i transakcije'
    end
    item
      IndexID = 270
      Text = 'Date of Ageing'
    ...
    item
      IndexID = 273
      Text = 'Mo'#382'nosti prikaza kontov'
    end
    item
      IndexID = 274
    ...
    item
      IndexID = 276
      Text = 'Prika'#382'i pod - konto'
    end
    item
      IndexID = 277
      Text = 'Opcije znacajki proracuna'
    end
    item
      IndexID = 278
      Text = 'Mo'#382'nosti glavne knjige'
    end
    item
      IndexID = 279
    ...
    item
      IndexID = 281
      Text = 'Mo'#382'nosti poskusne bilance'
    end
    item
      IndexID = 282
      Text = 'Od'
    ...
    item
      IndexID = 283
      Text = 'Poravnava bancnih racunov'
    end
    item
      IndexID = 284
      Text = 'Od '#352'tevilke'
    ...
    item
      IndexID = 288
      Text = 'Mo'#382'nosti pregleda dokumentov'
    end
    item
      IndexID = 289
      Text = 'Od kode izdelka'
    end
    item
      IndexID = 290
      Text = 'Mo'#382'nosti aktivnosti skladi'#353'ca'
    end
    item
      IndexID = 291
      Text = 'Kontrola dostopa'
    ...
    item
      IndexID = 294
      Text = 'Varnostne mo'#382'nosti'
    end
    item
      IndexID = 295
      Text = 'Uporabni'#353'ko geslo'
    end
    item
      IndexID = 296
      Text = 'Uredi konto'
    ...
    item
      IndexID = 305
      Text = 'Porocilo o dobavitelju'
    end
    item
      IndexID = 306
      Text = 'Porocilo o doll'#382'niku'
    end
    item
      IndexID = 307
      Text = 'Porocilo glavne knjige'
    end
    item
      IndexID = 308
      Text = 'Porocilo o zalogi'
    end
    item
      IndexID = 309
      Text = 'Uporabni'#353'ka porocila'
    ...
    item
      IndexID = 316
      Text = 'Maticna '#353'tevilka podjetja'
    end
    item
      IndexID = 317
      Text = 'Davcna '#353'tevilka podjetja'
    end
    item
      IndexID = 318
    ...
    item
      IndexID = 319
      Text = 'Pritisnite tukaj za nastavitev datuma v Windowsih'
    end
    item
      IndexID = 320
      Text = 'Informacije o podjetju'
    end
    item
      IndexID = 321
      Text = 'Naslednja '#353't. racuna'
    end
    item
      IndexID = 322
      Text = 'Skupina racunov'
    end
    item
      IndexID = 323
      Text = 'Vrsta papirja'
    ...
    item
      IndexID = 325
      Text = 'Sporocilo na racunu'
    end
    item
      IndexID = 326
      Text = 'Naslednja '#353't. dobropisa'
    end
    item
      IndexID = 327
      Text = 'Skupina dobropisov'
    end
    item
      IndexID = 328
      Text = 'Glava dobropisa'
    end
    item
      IndexID = 329
      Text = 'Sporocilo na dobropisu'
    end
    item
      IndexID = 330
      Text = 'Naslednja '#353't. prejema'
    end
    item
      IndexID = 331
      Text = 'Skupina prejemov'
    end
    item
      IndexID = 332
      Text = 'Glava prejema'
    ...
    item
      IndexID = 333
      Text = 'Sporocilo na prejemu'
    end
    item
      IndexID = 334
      Text = 'Naslednja '#353't. vracila'
    end
    item
      IndexID = 335
      Text = 'Skupina vracila'
    end
    item
      IndexID = 336
      Text = 'Glava vracila'
    ...
    item
      IndexID = 337
      Text = 'Sporocilo na vracilu'
    end
    item
      IndexID = 338
      Text = 'Naslednja '#353't. narocila'
    end
    item
      IndexID = 339
      Text = 'Glava narocila'
    ...
    item
      IndexID = 340
      Text = 'Sporocilo na narocilu'
    end
    item
      IndexID = 341
      Text = 'Naslednja '#353't. ponudbe'
    end
    item
      IndexID = 342
      Text = 'Glava ponudbe'
    ...
    item
      IndexID = 343
      Text = 'Sporocilo na ponudbi'
    end
    item
      IndexID = 344
      Text = 'Nastavitev dokumentov'
    end
    item
      IndexID = 345
      Text = 'Skupine'
    ...
    item
      IndexID = 347
      Text = 'Namestitev izjave'
    end
    item
      IndexID = 348
      Text = 'Besedilo na izjavi'
    end
    item
      IndexID = 349
      Text = 'Skupina stro'#353'kov prodaje'
    end
    item
      IndexID = 350
      Text = 'Informacije o zalogi'
    end
    item
      IndexID = 351
      Text = 'Pripravi stro'#353'ke prodaje'
    end
    item
      IndexID = 352
      Text = 'Splo'#353'ne informacije'
    end
    item
      IndexID = 353
      Text = 'Racunovodske informacije'
    end
    item
      IndexID = 354
      Text = 'Izjave'
    ...
    item
      IndexID = 375
      Text = 'Vrednost z davkom:'
    end
    item
      IndexID = 376
      Text = 'Vrednost brez davka:'
    end
    item
      IndexID = 377
      Text = 'Odgovarajuci zbroj:'
    end
    item
      IndexID = 378
    ...
    item
      IndexID = 380
      Text = 'Prodaja po kupcih'
    end
    item
      IndexID = 381
      Text = 'Prodaja po izdelku'
    end
    item
      IndexID = 382
      Text = 'Prodaja po prodajalcu'
    end
    item
      IndexID = 383
      Text = 'Prodaja po skupini'
    end
    item
      IndexID = 384
      Text = 'Prodaja po mo'#382'nostih kupca'
    end
    item
      IndexID = 385
      Text = 'Prodaja po mo'#382'nostih izdelka'
    end
    item
      IndexID = 386
      Text = 'Prodaja po mo'#382'nostih prodajalca'
    end
    item
      IndexID = 387
      Text = 'Prodaja po mo'#382'nostih skupine'
    end
    item
      IndexID = 388
      Text = 'Od skupine'
    ...
    item
      IndexID = 407
      Text = 'Prika'#382'i davcne transakcije'
    end
    item
      IndexID = 408
      Text = 'Porocilo o dol'#382'niku'
    end
    item
      IndexID = 409
      Text = 'Prika'#382'i davek posebej'
    end
    item
      IndexID = 410
    ...
    item
      IndexID = 421
      Text = 'Skupine dol'#382'nikov'
    end
    item
      IndexID = 422
      Text = 'Skupine dobaviteljev'
    end
    item
      IndexID = 423
      Text = 'Skupine skladi'#353'ca'
    end
    item
      IndexID = 424
      Text = 'Skupine dokumentov'
    end
    item
      IndexID = 425
      Text = 
        'Opozorilo, ta sprememba bo resno spremenila va'#353'e knjige, '#382'elite ' +
        #353'e vedno nadaljevati?'
    end
    item
      IndexID = 426
      Text = 'Izbrali ste brisanje vseh uporabnikov, dostop ne bo vec mogoc'
    end
    item
      IndexID = 427
      Text = 
        'Obstaja neposlana skupina, ki pripada temu uporabniku, prosimo v' +
        'as da jo po'#353'ljete ali izbri'#353'ete preden izbri'#353'ete tega uporabnika'
    end
    item
      IndexID = 428
      Text = 
        'Obstaja batch tega uporabnika, prosimo izberite novega uporabnik' +
        'a, ki mu bo dodana ta skupina'
    end
    item
      IndexID = 429
      Text = 
        '*Postoji transakcija od ovog korisnika, molimo vas odaberite nov' +
        'og korisnika kojem ce se pridru'#382'iti ta transakcija'
    end
    item
      IndexID = 430
      Text = 
        #381'elite shraniti spremembe, ki ste jih naredili za tega uporabnik' +
        'a?'
    end
    item
      IndexID = 431
      Text = 'Prosim vnesite geslo za tega uporabnika.'
    end
    item
      IndexID = 432
      Text = 'Ustvari konto?'
    ...
    item
      IndexID = 433
      Text = 'Nepravilna '#353't. konta, na prvem mestu mora biti '#353'tevilka.'
    end
    item
      IndexID = 434
      Text = 'To ni bancni konto.'
    end
    item
      IndexID = 435
      Text = #381'elite shraniti spremembe?'
    end
    item
      IndexID = 436
      Text = '!!! KRITICNA NAPAKA DATOTEKE 12 !!!'
    end
    item
      IndexID = 437
      Text = 'Ste prepricani da '#382'elite izbrisati transakcijo?'
    end
    item
      IndexID = 438
      Text = #381'elite prenesti to transakcijo na preteklo leto?'
    end
    item
      IndexID = 439
      Text = 'Skupina ni v izenacena.'
    end
    item
      IndexID = 440
      Text = 'Konto ne obstaja, ali ga '#382'elite odpreti?'
    end
    item
      IndexID = 441
      Text = #381'elite nadaljevati z porocilom?'
    end
    item
      IndexID = 442
      Text = 
        'Ne morem izbrisati te vrste skupine zaradi povezave z drugimi el' +
        'ementi.'
    end
    item
      IndexID = 443
      Text = 
        'Izmjena tipa skupine ce ozbiljno utjecati na va'#353'e knjige, dali s' +
        'te sigurni da '#382'elite uraditit to?'
    end
    item
      IndexID = 444
      Text = 
        'Ovo ce ozbiljno utjecati na va'#353'a konta, dali '#382'elite prekinuti ov' +
        'o sada?'
    end
    item
      IndexID = 445
      Text = #381'elite shraniti te spremembe?'
    end
    item
      IndexID = 446
      Text = 'Ste prepricani da '#382'elite ustvariti'
    end
    item
      IndexID = 447
      Text = 'Skupina knjig?'
    ...
    item
      IndexID = 448
      Text = 'Skupina knjig ustvarjena.'
    end
    item
      IndexID = 449
      Text = 'Napaka pri izdelavi knjig.'
    end
    item
      IndexID = 450
      Text = '*The'
    ...
    item
      IndexID = 451
      Text = 'Skupina knjig '#382'e obstaja.'
    end
    item
      IndexID = 452
      Text = 'Konto ne sme biti prazen.'
    end
    item
      IndexID = 453
      Text = 'Na prvem mestu mora biti '#353'tevilka.'
    end
    item
      IndexID = 454
      Text = 'Zakljuceno!'
    ...
    item
      IndexID = 455
      Text = 'Mapa ne vsebuje TurboCASH 2.01, 2.02 or 2.03 knjig.'
    end
    item
      IndexID = 456
      Text = 'Ste prepricani da '#382'elite prekiniti?'
    end
    item
      IndexID = 457
      Text = #381'elite ustvariti ta konto?'
    end
    item
      IndexID = 458
      Text = 'Ste prepricani da '#382'elite izbrisati'
    end
    item
      IndexID = 459
      Text = 'skupino knjig?'
    ...
    item
      IndexID = 460
      Text = 'Ste prepricani da '#382'elite izbrisati ta konto?'
    end
    item
      IndexID = 461
      Text = 'Ta konto vsebuje'
    end
    item
      IndexID = 462
      Text = 'pod-kont(i) ne more biti izbrisan.'
    end
    item
      IndexID = 463
      Text = 
        'Ne morete izbrisati izdelka ker je povezan z drugimi transakcija' +
        'mi.'
    end
    item
      IndexID = 464
      Text = 'Ste prepricani da '#382'elite izbrisati ta izdelek?'
    end
    item
      IndexID = 465
      Text = 'Izdelek je izbrisan.'
    end
    item
      IndexID = 466
      Text = 'Ta izdelek na obstaja.'
    end
    item
      IndexID = 467
      Text = 'To ni salda konto.'
    end
    item
      IndexID = 468
      Text = 
        'Ovaj konto je jo'#353' uvijek aktivan, sve transakcije ce biti premje' +
        #353'tene na naovi pod-konto, sigurni ste da '#382'elite napraviti ovaj p' +
        'od-konto?'
    end
    item
      IndexID = 469
      Text = 'To ni konto za davek'
    end
    item
      IndexID = 470
      Text = 'Vezani znesek mora biti manj'#353'i ali enak'
    end
    item
      IndexID = 471
      Text = 'Niste '#353'e ustvarili skupine knjig.'
    end
    item
      IndexID = 472
      Text = 'Vnos je '#382'e povezan.'
    end
    item
      IndexID = 473
      Text = 'S tem kupcen ni nobenih povezav.'
    end
    item
      IndexID = 474
      Text = 'Ste prepricani da '#382'elite razvezati ta vnos?'
    end
    item
      IndexID = 475
      Text = 'Napacno geslo'
    ...
    item
      IndexID = 476
      Text = 'Napaka pri datumu !!!! Preveri datum 1'
    end
    item
      IndexID = 477
      Text = 'Napaka pri datumu !!!! Preveri datum 2'
    end
    item
      IndexID = 478
      Text = 'Napaka pri datumu !!!! Preveri datum 3'
    end
    item
      IndexID = 479
      Text = 'Napaka pri datumu !!!! Preveri datum 4'
    end
    item
      IndexID = 480
      Text = 'Napaka pri datumu !!!! Preveri datum 5'
    end
    item
      IndexID = 481
      Text = 'Napaka pri datumu !!!! Preveri datum 6'
    end
    item
      IndexID = 482
      Text = 'Napaka pri datumu !!!! Preveri datum 7'
    end
    item
      IndexID = 483
      Text = 'Napaka pri datumu !!!! Preveri datum 8'
    end
    item
      IndexID = 484
      Text = 'Napaka pri datumu !!!! Preveri datum 9'
    end
    item
      IndexID = 485
      Text = 'Napaka pri datumu !!!! Preveri datum 10'
    end
    item
      IndexID = 486
      Text = 'Napaka pri datumu !!!! Preveri datum 11'
    end
    item
      IndexID = 487
      Text = 'Napaka pri datumu !!!! Preveri datum 12'
    end
    item
      IndexID = 488
      Text = 'Napaka pri datumu !!!! Preveri datum 13'
    end
    item
      IndexID = 489
      Text = 'Dovoljena so samo obdobja med 1 in 13'
    end
    item
      IndexID = 490
      Text = 'Ste prepricani da '#382'elite prekiniti spremembe?'
    end
    item
      IndexID = 491
      Text = 'Ni podatkov za poravnavo!'
    end
    item
      IndexID = 492
      Text = 'To ni konto iz skupine PRIHODKI/ODHODKI.'
    end
    item
      IndexID = 493
      Text = 'Konto vsebuje pod-konte.'
    end
    item
      IndexID = 494
      Text = #381'elite ustvariti nov izdelek?'
    end
    item
      IndexID = 495
    ...
    item
      IndexID = 496
      Text = 'Izberite uporabni'#353'ko porocilo'
    end
    item
      IndexID = 497
      Text = 'Kolicina zaloge'
    end
    item
      IndexID = 498
      Text = 'Opis prodajne cene'
    end
    item
      IndexID = 499
      Text = 'Stro'#353'ki prodaje'
    ...
    item
      IndexID = 500
      Text = #381'elite preveriti integriteto podatkov pred arhiviranjem?'
    end
    item
      IndexID = 501
    ...
    item
      IndexID = 503
      Text = 'Ovaj datum je van sada'#353'nje godine. On mora biti izmedu'
    end
    item
      IndexID = 504
      Text = 'i'
    ...
    item
      IndexID = 508
      Text = #381'elite li sigurno pocistiti sve upise u ovaj racun ?'
    end
    item
      IndexID = 509
    ...
    item
      IndexID = 512
      Text = 
        'Upozorenje ovo ce prebrisati va'#353'e sada'#353'nje knjige! Dal ste sigur' +
    ...
    item
      IndexID = 515
      Text = 
        'Ova kopija TurboCASH nije registrirana, dali '#382'elite da je odmah ' +
        'registrirate?'
    end
    item
      IndexID = 516
      Text = 
        'Ovo ce uni'#353'titi sve va'#353'e informacije. Dali ste sigurni da '#382'elite' +
        ' to uraditi?'
    end
    item
      IndexID = 517
    ...
    item
      IndexID = 519
      Text = 
        'Ovo ce ozbiljno promjeniti va'#353' skup knjiga, dali ste sigurni da ' +
        #382'elite ocistii ovaj skup knjiga?'
    end
    item
      IndexID = 520
    ...
    item
      IndexID = 521
      Text = 'Nepravilan kod za otkljucavanje.'
    end
    item
      IndexID = 522
    ...
    item
      IndexID = 590
      Text = 'Ova skupina nije potvrdena!'
    end
    item
      IndexID = 1
      Text = '&Ne'
    ...
    item
      IndexID = 544
      Text = 
        'Dobro do'#353'li u TurboCASH dio za izradu skupa knjiga . Molimo vas ' +
        'izaberite mogucnosti i stisnite na sljedece dugme ili stisnite d' +
        'ugme za poni'#353'tenje da poni'#353'tite izradu novih knjiga.'
    end
    item
      IndexID = 543
      Text = 'Gotovo'
    ...
    item
      IndexID = 550
      Text = 'Pretvaranje TurboCASH3 -> TurboCASH4?'
    end
    item
      IndexID = 549
    ...
    item
      IndexID = 548
      Text = 'Dopustite TurboCASH da izradi Skup knjiga?'
    end
    item
      IndexID = 547
      Text = 'Kopiranje postojeceg skupa knjiga?'
    end
    item
      IndexID = 546
    ...
    item
      IndexID = 563
      Text = 'Izradujem zahtjevani konto ( kontrolni za du'#382'nike)...'
    end
    item
      IndexID = 562
      Text = 'Izradujem zahtjevani konto (kontrolni za kreditore)...'
    end
    item
      IndexID = 561
      Text = 'Izradujem zahtjevani konto...'
    end
    item
      IndexID = 560
    ...
    item
      IndexID = 559
      Text = 'Mora'#353' izabrati skup knjiga i direktorij gdje ce'#353' kopirati.'
    end
    item
      IndexID = 558
      Text = 
    ...
    item
      IndexID = 566
      Text = 'Ucitavam podatke s Pastela...'
    end
    item
      IndexID = 565
    ...
    item
      IndexID = 564
      Text = 'Izradujem zahtjevana konta (Zadr'#382'ana dobit)...'
    end
    item
      IndexID = 575
      Text = 'Broj'
    ...
    item
      IndexID = 599
      Text = 'Unesi mjesec i godinu za ponavljajuci ulaz'
    end
    item
      IndexID = 600
      Text = 'Period'
    ...
    item
      IndexID = 612
      Text = 'Neograniceni uvoz datoteka'
    end
    item
      IndexID = 613
    ...
    item
      IndexID = 619
      Text = 'Napi'#353'i neogranicene datoteke'
    end
    item
      IndexID = 620
    ...
    item
      IndexID = 622
      Text = 'Mogucnosti za ovu skupinu'
    end
    item
      IndexID = 623
      Text = 'Povecanje referentnog broja'
    end
    item
      IndexID = 624
      Text = 'Ponovi detalje'
    ...
    item
      IndexID = 635
      Text = 'Morate imati skup knjiga otvoren za upoterbu ove mogucnosti.'
    end
    item
      IndexID = 636
    ...
    item
      IndexID = 637
      Text = 'Ukljuci otvorena poravnavanja'
    end
    item
      IndexID = 638
    ...
    item
      IndexID = 639
      Text = 
        'Informacije na ovoj liniji ce biti izgubljene ako se oni promjen' +
        'e za komentare'
    end
    item
      IndexID = 640
    ...
    item
      IndexID = 641
      Text = 
        'Ovo ce radikalno promjeniti va'#353'e podatke. Preporucujemo da stane' +
        'te i napravite backup.'
    end
    item
      IndexID = 642
      Text = #381'elite li nastaviti?'
    end
    item
      IndexID = 643
      Text = 
    ...
    item
      IndexID = 648
      Text = 'Jedinica iskljucena.'
    end
    item
      IndexID = 649
      Text = 'Jedinica ukjlucena.'
    end
    item
      IndexID = 650
      Text = 'Iznos iskljucen PDV.'
    end
    item
      IndexID = 651
      Text = 'Iznos ukljucen PDV.'
    end
    item
      IndexID = 652
      Text = 'Kod artikla'
    ...
    item
      IndexID = 655
      Text = 'Narucena kolicina'
    end
    item
      IndexID = 656
      Text = 'Isporucena kolicina'
    end
    item
      IndexID = 657
      Text = 'Popust.'
    ...
    item
      IndexID = 665
      Text = 
        'Promijenili ste skupinu za placanje i primitke, Ovo ce smetati v' +
    ...
    item
      IndexID = 668
      Text = 'Ne mo'#382'ete imati proracun za konto koji ima pod-konto.'
    end
    item
      IndexID = 669
    ...
    item
      IndexID = 674
      Text = 'Ucitaj povratnicu od kupca'
    end
    item
      IndexID = 675
    ...
    item
      IndexID = 679
      Text = 
        'Ne mo'#382'ete imati isti tip skupine za placanje kao drugi bankarski' +
        ' konto !'
    end
    item
      IndexID = 680
    ...
    item
      IndexID = 696
      Text = 'Netocan sljedeci broj, promjeni ga u namje'#353'tanju dokumenata.'
    end
    item
      IndexID = 697
    ...
    item
      IndexID = 701
      Text = 'Ucitaj povratnicu skladi'#353'ta'
    end
    item
      IndexID = 702
    ...
    item
      IndexID = 707
      Text = #381'elite li ispisati ovu narud'#382'benicu?'
    end
    item
      IndexID = 708
    ...
    item
      IndexID = 713
      Text = 'Ucitavam korisnicki server'
    end
    item
      IndexID = 714
    ...
    item
      IndexID = 717
      Text = 'Skup kniga nije probaden, direktorij ne postoji::'
    end
    item
      IndexID = 718
      Text = 'ili problemi na oznacenom mre'#382'nom pogonu'
    end
    item
      IndexID = 719
      Text = 
        'Ovo ce obrisati sve va'#353'e informacije dali ste sigurni da '#382'elite ' +
        'nastaviti?'
    end
    item
      IndexID = 720
    ...
    item
      IndexID = 722
      Text = 
        'Upozorenje, ako stisnete da, izgubit cete sve va'#353'e trenutne veze' +
        ' na ovaj konto.'
    end
    item
      IndexID = 723
    ...
    item
      IndexID = 724
      Text = 
        'Informacije za namje'#353'tanje interneta su netocne.Pokreni namje'#353'ta' +
        'nje interneta'
    end
    item
      IndexID = 725
    ...
    item
      IndexID = 741
      Text = 'Netocan pasword'
    end
    item
      IndexID = 742
      Text = 
        'Ne mo'#382'ete koristiti ovaj konto kao kontra konto buduci da on sad' +
        'r'#382'i pod-konto'
    end
    item
      IndexID = 743
    ...
    item
      IndexID = 744
      Text = 'Ovaj skup knjiga vec postoji. Molimo vas ponovo udite.'
    end
    item
      IndexID = 745
    ...
    item
      IndexID = 756
      Text = 'biti ce trajno izbrisano sa tvrdog diska.'
    end
    item
      IndexID = 757
    ...
    item
      IndexID = 764
      Text = 'Pritisni tipku zatvori za svr'#353'etak carobnjaka za namje'#353'tanje.'
    end
    item
      IndexID = 765
    ...
    item
      IndexID = 769
      Text = 'TurboCASH bi vas '#382'elio upozoriti da:'
    end
    item
      IndexID = 770
      Text = 
        'Napravite redoviti backup te spremite sigurnosne kopije va'#353'ih kn' +
        'jiga kako bi sprijecili mogucnost gubitka podataka.'
    end
    item
      IndexID = 771
      Text = 'Br. ponude:'
    ...
    item
      IndexID = 776
      Text = #381'elite li obrisati ovu kontakt osobu?'
    end
    item
      IndexID = 777
    ...
    item
      IndexID = 780
      Text = 
        'Sve transakcije ce biti izbrisane i konto uravnote'#382'en na nultu v' +
        'rijednost.'
    end
    item
      IndexID = 781
      Text = #381'elite li prekinuti proces ci'#353'cenja?'
    end
    item
      IndexID = 782
      Text = 'vec postoji!'
    ...
    item
      IndexID = 789
      Text = 'kamata koju mora platiti du'#382'nik koji je  zakasnio sa placanjem'
    end
    item
      IndexID = 790
    ...
    item
      IndexID = 800
      Text = #381'elite li zatvoritiTurboCASH?'
    end
    item
      IndexID = 801
    ...
    item
      IndexID = 804
      Text = 'Korisnicki izvje'#353'taj nije odabran, molimo vas odaberite jedan.'
    end
    item
      IndexID = 805
    ...
    item
      IndexID = 806
      Text = #381'elite li  promjeniti sljedeci broj dokumenta?'
    end
    item
      IndexID = 807
    ...
    item
      IndexID = 809
      Text = 'Kamata zanplaceni  dug mora biti izmdu 0 % to 99.99 %'
    end
    item
      IndexID = 810
    ...
    item
      IndexID = 812
      Text = 'Strai T3 podaci su uspje'#353'no prebaceni'
    end
    item
      IndexID = 813
    ...
    item
      IndexID = 814
      Text = 'Ne mogu naci neplaceni iznos.'
    end
    item
      IndexID = 815
      Text = 
        'Va'#353'a skupina primljenih i placenih racuna a nije dobro vezana za' +
    ...
    item
      IndexID = 817
      Text = 'Backup podaci nisu nadeni'
    end
    item
      IndexID = 818
    ...
    item
      IndexID = 820
      Text = 
        'Rad na bazi placanja a zahtjeva da se svi du'#382'nici i krediori pre' +
        'bace na konta sa otvorenim stavkama? '#381'elite li nastaviti'
    end
    item
      IndexID = 821
      Text = 
        'Metoda placanja poreza na bazi placanja a tretira porez na bazi ' +
        'placanja?Porez se mora paltiti dr'#382'avi samo kada je novac primlje' +
        'n od kupca.'#381'elite li nastaviti.'
    end
    item
      IndexID = 822
      Text = 
        'Vi radite u sustavu placanja poreza prema placanju, a  du'#382'nicki ' +
        'konto  ne mo'#382'e biti naden.Molimo vas uradite namje'#353'tanje podatak' +
        'a o poduzecu .'
    end
    item
      IndexID = 823
    ...
    item
      IndexID = 830
      Text = 'Molimo vas kontaktirajte va'#353'eg TC administratora.'
    end
    item
      IndexID = 831
    ...
    item
      IndexID = 855
      Text = 'Prodavac po prodanima proizvodima'
    end
    item
      IndexID = 856
      Text = 'Prodavac po kupcima'
    end
    item
      IndexID = 857
    ...
    item
      IndexID = 858
      Text = 'Proizvodi po prodavacima'
    end
    item
      IndexID = 859
      Text = 'Kupci po prodavacima'
    end
    item
      IndexID = 860
    ...
    item
      IndexID = 890
      Text = 'Za ukljucenje, otvori opcije izvje'#353'tajnih datuma'
    end
    item
      IndexID = 891
      Text = '*Backup'
    ...
    item
      IndexID = 913
      Text = 'Nisu nadene odgovarajuce knjige:'
    end
    item
      IndexID = 914
    ...
    item
      IndexID = 923
      Text = 'Netocan password'
    end
    item
      IndexID = 924
      Text = 'Preskacem datoteku:'
    end
    item
      IndexID = 925
    ...
    item
      IndexID = 967
      Text = 'Neregistrirana kopija TurboCASH-a'
    end
    item
      IndexID = 968
      Text = 'ograniceno je na 150 transakcija'
    end
    item
      IndexID = 969
      Text = '*&Get it Online'
    ...
    item
      IndexID = 970
      Text = 'Otkljucavajuci kod ( od TurboCASH):'
    end
    item
      IndexID = 971
    ...
    item
      IndexID = 972
      Text = 'Registriraj TurboCASH'
    end
    item
      IndexID = 973
      Text = 'da dobije'#353' svoj otkljucavajuci kod ili'
    end
    item
      IndexID = 974
      Text = 'Telefon:'
    ...
    item
      IndexID = 975
      Text = 
        'Ova kopija Turbo Casha nije registrirana dali je '#382'elite registri' +
        'rati sada?'
    end
    item
      IndexID = 976
    ...
    item
      IndexID = 979
      Text = 'Prika'#382'i decimale'
    end
    item
      IndexID = 980
      Text = 'Opcije prikaza racuna dobitka i gubitka'
    end
    item
      IndexID = 981
    ...
    item
      IndexID = 992
      Text = 'Proizvodi po kupcevim opcijama'
    end
    item
      IndexID = 993
      Text = 'Proizvodi po opcijama prodavaca'
    end
    item
      IndexID = 994
      Text = 'Kupci po opcijama prodavaca'
    end
    item
      IndexID = 995
    ...
    item
      IndexID = 996
      Text = 'Prodavac po opcijama kupca'
    end
    item
      IndexID = 997
      Text = 'Knjiga gotovinskog placanja'
    end
    item
      IndexID = 998
    ...
    item
      IndexID = 1006
      Text = #381'eliteli sigurno izbrisati ovaj korisnicki izvje'#353'taj?'
    end
    item
      IndexID = 1007
      Text = 
        'Ovo ce uvelike promjeniti va'#353'e knjige dali ste sigurni da '#382'elite' +
        ' obrisati ovaj tip skupine?'
    end
    item
      IndexID = 1008
      Text = 'Prodaja po opcijama proizvoda'
    end
    item
      IndexID = 1009
    ...
    item
      IndexID = 1033
      Text = 'Opcije analize placanja kreditorima'
    end
    item
      IndexID = 1034
      Text = 'Opcije knjige'
    ...
    item
      IndexID = 1051
      Text = 'Opcije po prodavacima i proizvodima'
    end
    item
      IndexID = 1052
      Text = 'Ocisti listu'
    ...
    item
      IndexID = 1055
      Text = #381'eli'#353' li obrisati prodavaca'
    end
    item
      IndexID = 1056
      Text = 'Sve prodajne cijene'
    end
    item
      IndexID = 1057
      Text = 'Nema'
    ...
    item
      ...
      Text = 
        ...
        'u izgradnju klljucnih vrijednosti'
    end
    item
      IndexID = 1063
    ...
    item
      IndexID = 1078
      Text = 'Primke po opcijama dobavljaca'
    end
    item
      IndexID = 1079
      Text = 'Tip'
    ...
    item
      IndexID = 1082
      Text = 'Opcije ponovnog narucivanja'
    end
    item
      IndexID = 1083
    ...
    item
      IndexID = 1124
      Text = 
        'Nedostaju ili su netocni podaci o kontrolnim kontima kreditorima' +
        ', Molimo vas kontaktirajte TurboCASH za pomoc.'
    end
    item
      IndexID = 1125
      Text = 'Dugovni'
    ...
    item
      IndexID = 1126
      Text = 'Placanje po vremenskom redosljedu'
    end
    item
      IndexID = 1127
    ...
    item
      IndexID = 1146
      Text = 'Povratnica od kupca prihvacena'
    end
    item
      IndexID = 1147
      Text = '*GRV Prihvacen'
    ...
    item
      IndexID = 1148
      Text = 'Ponuda prihvacena'
    end
    item
      IndexID = 1149
      Text = 'Narud'#382'ba prihvacena'
    end
    item
      IndexID = 1150
      Text = 'Dostavnica prihvacena'
    end
    item
      IndexID = 1151
      Text = 'Imovina'
    ...
    item
      IndexID = 1162
      Text = 
        'Dana'#353'nji dan je izmedu va'#353'eg financijskog perioda, morate naprav' +
    ...
    item
      IndexID = 1168
      Text = 'Molimo vas procitajte ovo'
    end
    item
      IndexID = 1169
      Text = 'Novac u kasi'
    ...
    item
      IndexID = 1197
      Text = 'TurboCASH4 podr'#353'ka'
    end
    item
      IndexID = 1198
      Text = 'TurboCASH potporna stranica'
    end
    item
      IndexID = 1199
    ...
    item
      IndexID = 1200
      Text = 'Iznos sa iskljucenim PDV-om'
    end
    item
      IndexID = 1201
      Text = 'Iznos sa ukljucenim PDV-om'
    end
    item
      IndexID = 1202
      Text = 'Ukupno:'
    ...
    item
      IndexID = 1210
      Text = 'Naden je ogranicen zapis'
    end
    item
      IndexID = 1211
      Text = 
        'Upi'#353'i '#353'to tra'#382'i'#353' ako '#382'eli'#353' tra'#382'iti odredeni tip, provjeri odgova' +
        'rajucu tipku ili pritisni dole za ponovno pretra'#382'ivanje'
    end
    item
      IndexID = 1212
    ...
    item
      IndexID = 1223
      Text = 'Pretvaranje ponude u racun'
    end
    item
      IndexID = 1224
    ...
    item
      IndexID = 1227
      Text = 'Tra'#382'i po broju'
    end
    item
      IndexID = 1228
      Text = 'Tra'#382'i po kontu'
    end
    item
      IndexID = 1229
      Text = 'Tra'#382'i po opisu'
    end
    item
      IndexID = 1230
      Text = 'Tijek novca'
    ...
    item
      IndexID = 1240
      Text = 'Dostupna novcana sredstva'
    end
    item
      IndexID = 1241
      Text = 'NOVAC PRIMLJEN'
    ...
    item
      IndexID = 1298
      Text = 'Svi korisnici se moraju izlogirati prije pocetka procesa'
    end
    item
      IndexID = 1299
      Text = 'Cekam da krenem ...'
    end
    item
      IndexID = 1300
      Text = 'Ponova izgradnja kljuceva'
    end
    item
      IndexID = 1301
      Text = 'Provjereno'
    ...
    item
      IndexID = 1302
      Text = 'Vrijednost kljuca'
    end
    item
      IndexID = 1303
      Text = 'Kvarenje kljuca'
    end
    item
      IndexID = 1304
    ...
    item
      IndexID = 1306
      Text = 'Transakcija Datum/Period ponovo izgradena'
    end
    item
      IndexID = 1307
    ...
    item
      IndexID = 1308
      Text = 'Ucitavam Message.db zapise'
    end
    item
      IndexID = 1309
    ...
    item
      IndexID = 1312
      Text = 'Dobit cete izvje'#353'taj po datumima'
    end
    item
      IndexID = 1313
      Text = 'Povratnica od kupca'
    ...
    item
      IndexID = 1331
      Text = 'velicina papira'
    end
    item
      IndexID = 1332
      Text = 'Kvaliteta papira'
    end
    item
      IndexID = 1333
      Text = 'Ostali'
    ...
    item
      IndexID = 1364
      Text = 'Standardni metod placanja'
    end
    item
      IndexID = 1365
      Text = 'Limit toka'
    ...
    item
      IndexID = 1385
      Text = 'Ladica na kasi prikljucena'
    end
    item
      IndexID = 1386
      Text = '*Barcode Scanner prikljucen'
    end
    item
      IndexID = 1387
      Text = '&Test ladice'
    ...
    item
      IndexID = 1414
      Text = 
        'Da ukljuci'#353' pristup koristi :Setup->System Parameteri->kontrola ' +
        'pristupa'
    end
    item
      IndexID = 1993
    ...
    item
      IndexID = 1700
      Text = 'Analiza dobavljaca po vremenu'
    end
    item
      IndexID = 586
      Text = '&Pomoc'
    ...
    item
      IndexID = 1738
      Text = 'Ovo ce zatvoriti ulau u  i poslati sve POS e na ...'
    end
    item
      IndexID = 1737
    ...
    item
      IndexID = 1720
      Text = 'Standardni kupcev  nije namje'#353'ten, molimo vas namjestite ga'
    end
    item
      IndexID = 1744
    ...
    item
      IndexID = 1739
      Text = 'Promjenjeno za uzvrcanje.'
    end
    item
      IndexID = 1778
      Text = 'Ponovo narucivanje'
    end
    item
      IndexID = 1777
      Text = 'Na zalihama'
    ...
    item
      IndexID = 1782
      Text = 'Prodajna cijena 3'
    end
    item
      IndexID = 1781
      Text = 'Prodajna cijena 2'
    end
    item
      IndexID = 1780
      Text = 'Prodajna cijena 1'
    end
    item
      IndexID = 1779
    ...
    item
      IndexID = 1803
      Text = 
        'Mijenjanje koda artikala rezultirat ce upotrebom tog koda kod sv' +
        'ih izvje'#353'taja.'
    end
    item
      IndexID = 1802
    ...
    item
      IndexID = 1815
      Text = 'Izaberi kontrolne konte, namjesti podatke o poduzecu i parametre'
    end
    item
      IndexID = 1814
      Text = 'Gotovo !'
    ...
    item
      ...
      Text = 
        ...
        'jskoj godini i postaviti pocetni datum ?'
    end
    item
      IndexID = 1821
      Text = 'Izradujem skup knjiga...'
    end
    item
      IndexID = 1833
      Text = 'Grupe konta'
    ...
    item
      IndexID = 1887
      Text = 'Ponavljanje racuna'
    end
    item
      IndexID = 1886
      Text = 'Povijest racuna'
    end
    item
      IndexID = 1885
      Text = 'Dugovanje'
    ...
    item
      IndexID = 1901
      Text = 'Pristup izvje'#353'tajima'
    end
    item
      IndexID = 1900
      Text = 'Korisnicki E-mail'
    end
    item
      IndexID = 1890
      Text = 'Dodaj sve'
    ...
    item
      IndexID = 1908
      Text = 'Izmijeni korisnicki izvje'#353'taj'
    end
    item
      IndexID = 1907
    ...
    item
      IndexID = 1913
      Text = 'Izaberi kategorije i dodijeli pripadajuce grupe'
    end
    item
      IndexID = 1912
      Text = 'Financijske kategorije'
    ...
    item
      IndexID = 1919
      Text = 'Ispi'#353'i obveze prije kapitala'
    end
    item
      IndexID = 1918
      Text = 'Ispi'#353'i kapital prije obveza'
    end
    item
      IndexID = 1917
      Text = '&Obveze'
    ...
    item
      IndexID = 1921
      Text = 'Ispi'#353'i rashode prije prihoda'
    end
    item
      IndexID = 1932
      Text = 'na'
    ...
    item
      IndexID = 1939
      Text = 'Upi'#353'i skracenicu :'
    end
    item
      IndexID = 1950
      Text = 'nije potvrdeno. Test nije uspio'
    end
    item
      IndexID = 1949
      Text = 'Potvrdeno'
    ...
    item
      IndexID = 1952
      Text = 'E-Mail Server nije pronaden...'
    end
    item
      IndexID = 1951
    ...
    item
      IndexID = 1957
      Text = 'Opca e-mail gre'#353'ka'
    end
    item
      IndexID = 1968
      Text = 
        'Ne mo'#382'ete imati vi'#353'e od 150 za ovu neregistriranu kopijuTurboCAS' +
        'H-a.'
    end
    item
      IndexID = 1967
      Text = 
        'Neregistrirani TurboCASH kopija je ogranicena na %s transakcija%' +
        'svi ste pre'#353'li %s %sMolimo vas registrirajte'
    end
    item
      IndexID = 1966
    ...
    item
      IndexID = 20008
      Text = 'Koristi mi'#353'a za dovlacenje kolone ovdje i grupiranje u tu kolonu'
    end
    item
      IndexID = 20019
      Text = 'Jednako sa'
    ...
    item
      IndexID = 20016
      Text = 'Aktivni nivo  tocaka ne postoji'
    end
    item
      IndexID = 20015
      Text = 'Pogled na  tocke ne postoji'
    end
    item
      IndexID = 20014
    ...
    item
      IndexID = 20036
      Text = 'je pro'#353'le godine'
    end
    item
      IndexID = 20035
      Text = 'je pro'#353'li mjesec'
    end
    item
      IndexID = 20034
      Text = 'je pro'#353'li tjedan'
    end
    item
      IndexID = 20033
      Text = 'je sutra'
    ...
    item
      IndexID = 20042
      Text = 'je sljedece godine'
    end
    item
      IndexID = 20041
      Text = 'je sljedeci mjesec'
    end
    item
      IndexID = 20040
      Text = 'je sljedeci tjedan'
    end
    item
      IndexID = 20039
      Text = 'je ove godine'
    ...
    item
      IndexID = 20078
      Text = 
        'Ova verzija ce raditi do1-3-2005, vi'#353'e informacija saznaj na htt' +
    ...
    item
      IndexID = 1969
      Text = 
        'Ne mo'#382'ete imati vi'#353'e od %s za ovu neregistriranu kopij%uTurboCAS' +
        'H-a, molimo vas registrirajte i dobijte licencu.'
    end
    item
      IndexID = 1988
    ...
    item
      IndexID = 20103
      Text = 'Sadr'#382'i sljedece uvjete'
    end
    item
      IndexID = 20102
    ...
    item
      IndexID = 2021
      Text = 'Uvoz podataka u TurboCASH'
    end
    item
      IndexID = 2022
    ...
    item
      IndexID = 2023
      Text = 'Nije ugraden uvoz tog formata datoteke'
    end
    item
      IndexID = 2024
    ...
    item
      IndexID = 2027
      Text = 'Format datoteke'
    end
    item
      IndexID = 2028
      Text = 'Kliknite na import za pocetak procesa'
    end
    item
      IndexID = 2029
    ...
    item
      IndexID = 2033
      Text = 'Izmjena podataka o poduzecu'
    end
    item
      IndexID = 2034
    ...
    item
      IndexID = 2054
      Text = 'Zapis je zakljucao drugi korisnik. Ponovite!'
    end
    item
      IndexID = 2056
      Text = 'Ispi'#353'i racun'
    end
    item
      IndexID = 2057
    ...
    item
      IndexID = 2059
      Text = 'Ne mogu dobii novi broj zapis je zatvoren probjte ponovo kasnije'
    end
    item
      IndexID = 2060
    ...
    item
      IndexID = 2098
      Text = 
        'Jo'#353' uvije imate izmos za primiti. %s Ne mo'#382'e se napustiti neplac' +
        'eni iznos za POS racun'
    end
    item
      IndexID = 2099
      Text = 'Predlo'#382'ak  izvje'#353'tajne datoteke nije pronaden'
    end
    item
      IndexID = 2100
      Text = 'Koristi OK za pamcenje novog imena'
    end
    item
      IndexID = 2101
      Text = 'Opci brojevi'
    ...
    item
      IndexID = 2110
      Text = 'Prodi kroz folder'
    end
    item
      IndexID = 2111
      Text = 'Samoraspakirajuci exe'
    end
    item
      IndexID = 2112
      Text = '*E-mail Backup'
    ...
    item
      IndexID = 2120
      Text = 
        'Izmjena koda rezultirat ce upotrebom toga koda u svim izvje'#353'taji' +
        'ma.'
    end
    item
      IndexID = 2121
    ...
    item
      IndexID = 2158
      Text = 'Kupcev ukupni iznos :'
    end
    item
      IndexID = 2159
      Text = 'Analiza prodaje - Prodaja po kupcu'
    end
    item
      IndexID = 2160
      Text = 'Ukupno primke :'
    ...
    item
      IndexID = 2161
      Text = 'Roba/vraceno Total :'
    end
    item
      IndexID = 2162
      Text = 'Ukupno dobavljac :'
    end
    item
      IndexID = 2163
      Text = 'Analiza prodaje - Primke po dobavljacu'
    end
    item
      IndexID = 2167
    ...
    item
      IndexID = 2177
      Text = 'Iznos poreza pronaden ali je porezni konto  izbrisan'
    end
    item
      IndexID = 2178
    ...
    item
      IndexID = 2193
      Text = 'Nizozemski nacin odbrojavanja texta.'
    end
    item
      IndexID = 2194
    ...
    item
      IndexID = 2215
      Text = 'Racun u banci za placanje'
    end
    item
      IndexID = 2216
    ...
    item
      IndexID = 2226
      Text = 'Izvje'#353'taj o placanju prema kreditorima'
    end
    item
      IndexID = 2227
      Text = 'Ukupno redova'
    ...
    item
      IndexID = 2249
      Text = 'Ova mogucnost trenutno nije ugradena.'
    end
    item
      IndexID = 2250
    ...
    item
      IndexID = 2251
      Text = 'Windowsov brojac vremena nije dostupan.'
    end
    item
      IndexID = 2252
    ...
    item
      IndexID = 2253
      Text = 'Ispravljac stavaka datoteka.'
    end
    item
      IndexID = 2254
    ...
    item
      IndexID = 2255
      Text = 'Konflikt sa drugim exl. dogadajem.'
    end
    item
      IndexID = 2256
      Text = 'Vrijeme svr'#353'etka ne mo'#382'e odrediti vrijeme pocetka.'
    end
    item
      IndexID = 2257
    ...
    item
      IndexID = 2269
      Text = 'Pogra'#353'ka: Pogre'#353'ka pri izradi dogadaja.'
    end
    item
      IndexID = 2271
    ...
    item
      IndexID = 2273
      Text = 'Pogre'#353'ka: Odredena je kriva tablica.'
    end
    item
      IndexID = 2274
      Text = 'Pogre'#353'ka: Nemoguce je otvoriti'
    end
    item
      IndexID = 2275
      Text = 'Pogre'#353'ka: Nije moguce ucitati'
    end
    item
      IndexID = 2276
      Text = 'Asistent'
    ...
    item
      IndexID = 2324
      Text = 'Mjesecno po danu'
    end
    item
      IndexID = 2325
      Text = 'Mjesecno po datumu'
    end
    item
      IndexID = 2326
      Text = 'Godi'#353'nje po danu'
    end
    item
      IndexID = 2327
      Text = 'Godi'#353'nje po datumu'
    end
    item
      IndexID = 2328
      Text = 'Kupac'
    ...
    item
      IndexID = 2350
      Text = 'Promjeni dogadaj...'
    end
    item
      IndexID = 2351
      Text = '&Obri'#353'i dogadaj...'
    end
    item
      IndexID = 2352
      Text = 'Izmijeni datum'
    ...
    item
      IndexID = 2407
      Text = 'Vrijeme pocetka:'
    end
    item
      IndexID = 2408
      Text = 'Vrijeme zavr'#353'etka:'
    end
    item
      IndexID = 2409
      Text = '&Podsjetnik'
    ...
    item
      IndexID = 2775
      Text = 'Datoteka %s ne mo'#382'e biti nadena'
    end
    item
      IndexID = 2776
    ...
    item
      IndexID = 2777
      Text = 'HTTP zahtjev za citanjem nedostaje'
    end
    item
      IndexID = 2778
    ...
    item
      IndexID = 2785
      Text = 'nedostaje ftp zahtjev za citanjem'
    end
    item
      IndexID = 2786
    ...
    item
      IndexID = 2789
      Text = 'Ne m'#382'e se ucitati izvor'
    end
    item
      IndexID = 2790
    ...
    item
      IndexID = 2795
      Text = 'Kriva kljucna rijec za atribute osnovne vrijednosti:'
    end
    item
      IndexID = 2796
    ...
    item
      IndexID = 2798
      Text = 'Kondicionalni dio mora poceti sa Ukljuci ili IGNORIRAJ'
    end
    item
      IndexID = 2799
    ...
    item
      IndexID = 2800
      Text = 'Ocekivan komentar ili or CDATA dio'
    end
    item
      IndexID = 2801
      Text = 'Neocekivani kraj datoteke'
    end
    item
      IndexID = 2802
    ...
    item
      IndexID = 2808
      Text = 'Ocekivan " ili '#39
    end
    item
      IndexID = 2809
      Text = 'XMLPartner nema podr'#353'ku XML zncajke vce od %s'
    end
    item
      IndexID = 2810
    ...
    item
      IndexID = 2813
      Text = 
        'Dokument ne mo'#382'e startati s komentarom ako on takoder  sadr'#382'i  X' +
        'ML declaraciju'
    end
    item
      IndexID = 2814
    ...
    item
      IndexID = 2820
      Text = 
        'Kondicionalana sekcija nije dozvoljena u inetrnoj zamjeni intern' +
        'al  od deklaracije tipa dokumenta'
    end
    item
      IndexID = 2821
      Text = 'Zapis nije odreden:'
    end
    item
      IndexID = 2822
    ...
    item
      IndexID = 2833
      Text = 'Odreden je krivi karakter dekodera.'
    end
    item
      IndexID = 2834
    ...
    item
      IndexID = 2835
      Text = 'Nepoznat odredivac osi: %s'
    end
    item
      IndexID = 2836
      Text = 'Krivi XML karakter je pronaden'
    end
    item
      IndexID = 2837
    ...
    item
      IndexID = 2852
      Text = 'Vlasnik mora bit TWinControl odreden'
    end
    item
      IndexID = 2853
    ...
    item
      IndexID = 2856
      Text = 'Lokalizacijska datoteka nije pronadena.'
    end
    item
      IndexID = 2857
      Text = 'Sastanak'
    ...
    item
      IndexID = 2880
      Text = 
        'Molimo vas spremite ovaj ponavljajuci racun sada. Nakon ponavlja' +
    ...
    item
      IndexID = 2936
      Text = 'Displej za kupca prikljucen'
    end
    item
      IndexID = 2937
      Text = 'Vidite li ovo ??'
    ...
    item
      IndexID = 2945
      Text = 'Brzo prebacivanje porodavaca'
    end
    item
      IndexID = 2946
    ...
    item
      IndexID = 2952
      Text = 
        'Ovim cete maknuti trenutnu registraciju i otvoriti novi obrazac ' +
        'za registraciju ! '#381'elite li  prekinuti to?'
    end
    item
      IndexID = 2953
      Text = 'Ispi'#353'i barkodove'
    end
    item
      IndexID = 2954
    ...
    item
      IndexID = 3100
      Text = 
        '*You are trying to connect to a remote database! This version do' +
        'es not support that by default! Please contact us at http://www.' +
        'osf-boekhoudpakket-administratie.nl/index.php/en/webshop to supp' +
        'ort the project and receive your multi-user license!'
    end
    item
      IndexID = 3101
      Text = '*Unregistered'
    ...
    item
      IndexID = 3123
      Text = 'Dobrodo'#353'li na TurboCASH'
    end
    item
      IndexID = 3124
      Text = 'Forward'
    ...
    item
      IndexID = 1000000
      Text = 'Republika Slovenija (slovenski jezik)'
    end
    item
      IndexID = 1000001
