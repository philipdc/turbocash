object TTranslationSaveObject
  aTranslationCollection = <
    ...
    item
      IndexID = 284
      Text = 'From Invoice Number'
    end
    item
      IndexID = 285
      Text = 'To Invoice Number'
    end
    item
      IndexID = 286
      Text = 'From Date'
    ...
    item
      IndexID = 336
      Text = 'Supplier Return Heading'
    end
    item
      IndexID = 337
      Text = 'Supplier Return Message'
    end
    item
      IndexID = 338
    ...
    item
      IndexID = 442
      Text = 
        'Cannot delete this batch type, as it has batches associated with' +
        ' it.'
    end
    item
      IndexID = 443
    ...
    item
      IndexID = 493
      Text = 'This account contains Sub-accounts.'
    end
    item
      IndexID = 494
    ...
    item
      IndexID = 679
      Text = 
        'Cannot  have the same Payments Batch type as for another Bank Ac' +
        'count!'
    end
    item
      IndexID = 680
    ...
    item
      IndexID = 701
      Text = 'Update Supplier Returns'
    end
    item
      IndexID = 702
      Text = 'From Supplier Return'
    end
    item
      IndexID = 703
      Text = 'Purchase No.'
    ...
    item
      IndexID = 708
      Text = 'Do you wish to print this Supplier Return?'
    end
    item
      IndexID = 709
    ...
    item
      IndexID = 775
      Text = 'Do you want to create this contact person?'
    end
    item
      IndexID = 776
      Text = 'Do you want to delete this contact person?'
    end
    item
      IndexID = 777
      Text = 'Contact Person Deleted.'
    end
    item
      IndexID = 778
    ...
    item
      IndexID = 805
      Text = 'Do you want to fill all details for this new contact?'
    end
    item
      IndexID = 806
    ...
    item
      IndexID = 816
      Text = 
        'May not have a Tax Type for a Debtor or Creditor in the payments' +
        ' based system.'
    end
    item
      IndexID = 817
    ...
    item
      IndexID = 830
      Text = 'Please contact your TurboCASH Administator.'
    end
    item
      IndexID = 831
    ...
    item
      IndexID = 832
      Text = 'Account does not exist, operation cannot be performed.'
    end
    item
      IndexID = 833
    ...
    item
      ...
      Text = 
        ...
        'count, Stock Control Account (and Cost of Sales Account) and the' +
        'n Post it'
    end
    item
      IndexID = 967
    ...
    item
      IndexID = 970
      Text = 'Unlocking Code (FromTurboCASH):'
    end
    item
      IndexID = 971
      Text = 'Serial Number:'
    ...
    item
      IndexID = 1414
      Text = 'Enable access in Setup->System Parameters->Access Control'
    end
    item
      IndexID = 1700
    ...
    item
      IndexID = 20004
      Text = 'Click here to add a new row'
    end
    item
      IndexID = 20003
    ...
    item
      IndexID = 1969
      Text = 
        'Cannot have more than %s for this unregisted TurboCASH Copie%s P' +
        'lease Register and Get your licence code.'
    end
    item
      IndexID = 1988
    ...
    item
      IndexID = 20102
      Text = 'Push this button to add a condition'
    end
    item
      IndexID = 20101
      Text = 'Delete &all'
    ...
    item
      IndexID = 2163
      Text = 'Sales Analysis - Purchases by Supplier'
    end
    item
      IndexID = 2162
    ...
    item
      IndexID = 1000000
      Text = 'Default Countries (English)'
    end
    item
      IndexID = 1000001
