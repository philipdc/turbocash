object TTranslationSaveObject
  aTranslationCollection = <
    ...
    item
      IndexID = 16
      Text = '&Tyila isixa sencwadi'
    end
    item
      IndexID = 17
      Text = '&Yakha isixa sencwadi'
    end
    item
      IndexID = 18
      Text = '&Cima isixa sencwadi'
    end
    item
      IndexID = 20
      Text = '&Tshintsha ulwimi'
    end
    item
      IndexID = 21
      Text = '&Yiya kwi TurboCASH'
    end
    item
      IndexID = 22
      Text = '&Amatyala'
    ...
    item
      IndexID = 25
      Text = '&Phinda amangeniso'
    end
    item
      IndexID = 26
      Text = 'Phinda amaxabiso'
    end
    item
      IndexID = 27
      Text = '&Stock items'
    ...
    item
      IndexID = 28
      Text = '&Umsebenzi ngxelo'
    end
    item
      IndexID = 29
      Text = '&Iaccount Yebanki'
    end
    item
      IndexID = 30
      Text = '& Amatyala'
    ...
    item
      IndexID = 41
      Text = 'Cima isitokwe esibuyisiweyo'
    end
    item
      IndexID = 42
      Text = '&Linganisa isitokwe'
    end
    item
      IndexID = 43
      Text = '&Faka ibaBatch Entry'
    end
    item
      IndexID = 44
      Text = '&Reconcile bank'
    ...
    item
      IndexID = 47
      Text = '&Yenza inotes zamathala akho'
    end
    item
      IndexID = 48
      Text = '&Invoices'
    ...
    item
      IndexID = 53
      Text = '&Landelelanisa iledger'
    end
    item
      IndexID = 54
      Text = 'Printa &Inotes ozakuzihambisa'
    end
    item
      IndexID = 55
      Text = '&Bhala ibatch'
    ...
    item
      IndexID = 175
      Text = 'Nika isixa sencwadi ezintsha igama'
    end
    item
      IndexID = 176
      Text = 'Inombolo yeAccount'
    end
    item
      IndexID = 177
      Text = 'Sub-account'
    ...
    item
      IndexID = 192
      Text = 'Ityala elikulingeneyo'
    end
    item
      IndexID = 193
      Text = 'Imali oyibizayo'
    end
    item
      IndexID = 194
      Text = 'Ibalance yakho'
    ...
    item
      IndexID = 195
      Text = 'Ukuqhibela kwam ukubhatala'
    end
    item
      IndexID = 196
      Text = 'Ukuqhubekaka'
    ...
    item
      IndexID = 199
      Text = 'Idilesi yedelivery'
    end
    item
      IndexID = 200
      Text = 'Umyalezo weStatement'
    end
    item
      IndexID = 201
      Text = 'Ityala elaphukileyo'
    end
    item
      IndexID = 202
      Text = 'ITax Reference'
    ...
    item
      IndexID = 203
      Text = 'Idiscount kwicustomer'
    end
    item
      IndexID = 204
      Text = 'Ulwengezelelo mali kwityala eliqhithileyo'
    end
    item
      IndexID = 205
      Text = '%'
    ...
    item
      IndexID = 217
      Text = 'Uhtengiso lwesibini'
    end
    item
      IndexID = 218
      Text = 'Uthengiso lwesithathu'
    end
    item
      IndexID = 219
      Text = 'Itax eyongziweyo'
    end
    item
      IndexID = 220
      Text = 'Itax engafakwanga'
    end
    item
      IndexID = 221
      Text = 'Idolo ekwilevel'
    end
    item
      IndexID = 222
    ...
    item
      IndexID = 243
      Text = 'Ukususela kumhla wengxelo'
    end
    item
      IndexID = 244
      Text = 'Ixesha ngalinye ngokwahlukeneyo'
    end
    item
      IndexID = 245
    ...
    item
      IndexID = 557
      Text = 'Yiya esiphelweni ukuyicacisa:'
    end
    item
      IndexID = 556
      Text = 
        'Ngoku yenza amanani exesha othe walisebenzisa kwimali yonyaka om' +
        'nye kunye nomhla oqale ngawo.'
    end
    item
      IndexID = 555
      Text = 'Yenza isixa samatyala....'
    end
    item
      IndexID = 554
      Text = 'xela okufumanayo'
    end
    item
      IndexID = 553
    ...
    item
      IndexID = 563
      Text = 'Yiba noqoqosho kumatyala akho...'
    end
    item
      IndexID = 562
      Text = 'Yiba noqoqosho kumatyala akho...'
    ...
    item
      IndexID = 561
      Text = 'Yenza amatyala akulingeneyo...'
    end
    item
      IndexID = 560
      Text = 'Yiba nesixa sencwadi...'
    end
    item
      IndexID = 559
      Text = 'Khetha isixa sencwadi usikhuphele directory'
    end
    item
      IndexID = 558
      Text = 'Le directory ayina sixa sencwadi, incwadi zonakele.'
    end
    item
      IndexID = 569
      Text = 'Hlisa isitokwe sepastel...'
    end
    item
      IndexID = 568
      Text = 'Hlisa amatyala epastel...'
    end
    item
      IndexID = 567
    ...
    item
      IndexID = 566
      Text = 'Funda ingcina ncukacha zepastel...'
    end
    item
      IndexID = 565
      Text = 'Hlisa isixa sencwadi...'
    end
    item
      IndexID = 564
      Text = 'Yenza  amatyala afikelekayo...'
    end
    item
      IndexID = 575
      Text = 'Inombolo'
    ...
    item
      IndexID = 574
      Text = 'Thatha into yokubonisa'
    end
    item
      IndexID = 573
      Text = 
        'Khetha into yukugcina umngane wepastel uyihlisele koluluhlu lung' +
        'ezantsi.'
    end
    item
      IndexID = 572
      Text = 'Khetha incwadi endala koluluhlu lungezantsi.'
    end
    item
      IndexID = 571
      Text = 'Khetha into yokugcina incukacha zepastel'
    end
    item
      IndexID = 570
    ...
    item
      IndexID = 710
      Text = 'Do you wish to print this quote?'
    end
    item
      IndexID = 711
      Text = 
    ...
    item
      IndexID = 816
      Text = 
        'May not have a VAT type for a debtor or creditor in the payments' +
        ' based system!'
    end
    item
      IndexID = 817
    ...
    item
      IndexID = 919
      Text = 'Process cancelled by the user!'
    end
    item
      IndexID = 920
    ...
    item
      IndexID = 1078
      Text = 'Purchases per supplier options'
    end
    item
      IndexID = 1079
      Text = 'Type'
    ...
    item
      IndexID = 20017
      Text = 'Cannot create the export output file!'
    end
    item
      IndexID = 20016
    ...
    item
      IndexID = 20111
      Text = 'to present multiple characters'
    end
    item
      IndexID = 20110
    ...
    item
      IndexID = 2163
      Text = 'Sales analysis - Purchases per supplier'
    end
    item
      IndexID = 2162
    ...
    item
      IndexID = 903141
      Text = 'Trim debtor address and set first character to the UPPER-CASE'
    end
    item
      IndexID = 903142
