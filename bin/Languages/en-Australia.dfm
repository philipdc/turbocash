object TTranslationSaveObject
  aTranslationCollection = <
    ...
    item
      IndexID = 816
      Text = 
        'May not have a GST type for a debtor or creditor in the payments' +
        ' based system!'
    end
    item
      IndexID = 817
    ...
    item
      IndexID = 2177
      Text = 'GST amount found but GST account is deleted!'
    end
    item
      IndexID = 2176
      Text = 'Current date'
